...
public class ManaTurnController : MonoBehaviour
{
    public ManaCarController player;
    public ManaEnemyAI enemy;
    ...
    void Update()
    {
        nitroP.text = player.nitro.ToString();
        nitroE.text = enemy.nitro.ToString();
    ...
    */
    ...
    public void endTurn()
    {
        ...
        if (turn % 2 == 1)
        {
            ...
            enemy.tarred = false;
            if(!player.countered && player.nitro != 4)
            {
                player.nitro += 1;
            }
            //Turn on action UI
        ...
        else
        {
            ...
            print("Enemy turn");
            if(!enemy.countered && enemy.nitro != 4)
            {
                enemy.nitro += 1;
            }
